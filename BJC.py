...
# Sidebar for money display and instructions
with st.sidebar:
    st.header("Balances")
    ...
    st.write("1. Click *Play* to start.")
    st.write("2. Place your bet.")
    st.write("3. *Hit* or *Stand* during your turn.")
    st.write("4. See the result and play again.")
...
if phase == 'start':
    ...
    st.info("Click 'Play' to begin or 'Quit' to exit.")
    ...
    bet = st.number_input("Enter your bet", min_value=0.01, max_value=st.session_state.player_money, step=0.01)
